...
<!-- a este div se le agrega la clase "login-colum"  que hace que el contenedor del login se centre en resolucion para moviles-->
            ...
            <a href="">
                <svg width="46" height="84" viewBox="0 0 46 84" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                            ...
                            fill="white" />
                    <path
                            d="M23.5 0.018852C32.3 8.81885 33.8333 20.6855 33.5 25.5189V25.7518C34.1667 21.0075 34.8 10.3189 32 5.51885C29.2 0.718852 25.1667 -0.147815 23.5 0.018852Z"
                            fill="white" />
                </svg>
            </a><br>
        </div>
        ...
        <form class="login-form"  action="../usuarioServlet" method="post" >
            ...
            <div class="form-group align-items-center">
                ...
                <div class="input-container">
                    ...
                    <input type="text" id="username" name="username" class="form-control" placeholder="Correo electronico" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-container">
                    <i class="fas fa-lock" style="color: #003366;"></i>
                    <input type="password" id="password" name="password" class="form-control" placeholder="Contraseña" required>
                </div>
            </div>
            <div class="form-group form-check d-flex justify-content-end">
                <input type="checkbox" class="form-check-input" id="remember-me">
                <!-- falta hacer la funcionalidad ed visualizar lal contraseña -->
